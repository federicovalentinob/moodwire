...
case 'topics':
    ...
    $sql_all = 'SELECT t.*,
                ...
                ORDER BY latest_article_at DESC, t.anxiety_avg DESC';
    ...
    json_out(['topics' => $page, 'total' => count($all_topics), 'offset' => 0, 'limit' => $limit]);
...
case 'stats':
    ...
    $row['last_updated'] = db()->query('SELECT MAX(fetched_at) FROM articles')->fetchColumn();
    json_out($row);
